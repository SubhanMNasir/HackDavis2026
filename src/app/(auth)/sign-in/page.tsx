// Sign-in screen.
// Mobile: 288px gradient hero with 12 hand-placed Lucide leaves at varying
//   sizes/rotations + Clerk <SignIn /> below.
// iPad: split layout — 520px gradient hero on the left, sign-in form pane right.
// (Per wellspring-build-brief.md §Screen 1.)
...
// 12 hand-placed leaves spread across the entire 288px hero (per brief: not bunched at the top).
...
// 24 leaves for the 520px iPad hero (denser, brief calls for "same" eyebrow + 24 leaves).
